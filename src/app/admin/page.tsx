...
import Container from '@/components/layout-admin/container/page';
import Navbar from '@/components/layout-admin/navbar/page';
import DataTable from './DataTable'; // Adjust the import path if necessary
